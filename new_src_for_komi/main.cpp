...
void mouse_move_callback(GLFWwindow* /*window*/, double xpos, double ypos)
{
	...
	if (scene.inputs.keyboard.ctrl && scene.inputs.mouse.click.right) {
		scene.environment.camera.manipulator_rotate_trackball(scene.inputs.mouse.position.previous, scene.inputs.mouse.position.current);
	}
}
